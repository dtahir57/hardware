		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default card-view">
				<div class="panel-heading">
					<div class="pull-left">
						<h6 class="panel-title txt-dark">New Shipping Rule</h6>
					</div>
				...
				<div class="panel-wrapper collapse in">
					<div class="panel-body">
						<div class="form-wrap">
							<form action="{{ route('shipping_rule.store') }}" method="POST" enctype="multipart/form-data">
								@csrf
								<div class="row">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" name="shipping_features" value="{{ old('shipping_features') }}" class="form-control" placeholder="Shipping Features" />
									</div>
									<div class="form-group col-md-6">
										<label class="control-label mb-10 text-left">Minimum Order Total</label>
										<input type="number" name="minimum_order_total" min="0" class="form-control" placeholder="Minimum Order Total" value="{{ old('minimum_order_total') }}" required />
									</div>
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										<div class="checkbox checkbox-success">
											<input id="checkbox4" type="checkbox" name="is_exclusive" value="1" />
