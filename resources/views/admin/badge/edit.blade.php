...
@section('admin-title', 'Edit Badge')
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default card-view">
				<div class="panel-heading">
					<div class="pull-left">
						<h6 class="panel-title txt-dark">Edit Badge</h6>
					</div>
							...
							<form action="{{ route('badge.update', $badge->id) }}" method="POST">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" name="name" class="form-control" placeholder="Badge Name" value="{{ $badge->name }}" required />
									</div>
								</div>
