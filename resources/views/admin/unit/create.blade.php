		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default card-view">
				<div class="panel-heading">
					<div class="pull-left">
						<h6 class="panel-title txt-dark">New Unit</h6>
					</div>
							...
							<form action="{{ route('unit.store') }}" method="POST">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" name="name" class="form-control" placeholder="Unit Name" value="{{ old('name') }}" required />
									</div>
								</div>
