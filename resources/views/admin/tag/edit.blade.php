		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default card-view">
				<div class="panel-heading">
					<div class="pull-left">
						<h6 class="panel-title txt-dark">Edit Tag</h6>
					</div>
							...
							<form action="{{ route('tag.update', $tag->id) }}" method="POST">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" name="name" class="form-control" placeholder="Name" value="{{ $tag->name }}" required />
									</div>
									<div class="form-group col-md-6">
										<label>Status</label>
										<div class="checkbox checkbox-success">
											<input id="checkbox4" type="checkbox" name="is_active" value="1" @if($tag->is_active) checked @endif />
