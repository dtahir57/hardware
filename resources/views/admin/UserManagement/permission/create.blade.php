...
@section('admin-title', 'New Permission')
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default card-view">
				<div class="panel-heading">
					<div class="pull-left">
						<h6 class="panel-title txt-dark">New Permission</h6>
					</div>
							...
							<form action="{{ route('permission.store') }}" method="POST">
								...
								<div class="row">
									<div class="form-group col-md-6">
										...
										<input type="text" name="module" value="{{ old('module') }}" class="form-control" placeholder="Module" required />
									</div>
									<div class="form-group col-md-6">
